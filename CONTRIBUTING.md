...
* This repository ([documents](https://github.com/nextcloud/documents/issues)) is *only* for issues within the Nextcloud documents code.
...
Please check [servers's contribution guidelines](https://github.com/nextcloud/server/blob/master/CONTRIBUTING.md) for further information about contributing code and translations.
